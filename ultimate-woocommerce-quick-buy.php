    ...
    if (!class_exists('Ultimate_WooCommerce_Quick_Buy')) {
        class Ultimate_WooCommerce_Quick_Buy
        {
            ...
            public $_defaultOptions = array(
                ...
                'popup_sucess' => '<div class="popup-message success" style="color:#333;"><p class="clearfix" style="font-size:22px;color: #00c700;text-align:center">Đặt hàng thành công!</p><p class="clearfix" style="color: #00c700;padding: 10px 0;">Mã đơn hàng <span style="color: #333;font-weight: bold">#%%order_id%%</span></p><p class="clearfix">Uwc SHOP sẽ liên hệ với bạn trong 12h tới. Cám ơn bạn đã cho chúng tôi cơ hội được phục vụ.<br><strong>Hotline:</strong> 0936.xxx.xxx</p><div></div><div></div></div>',
            ...
            function dvls_load_textdomain() {
                load_textdomain('ultimate-woocommerce-quick-buy', dirname(__FILE__) . '/languages/ultimate-woocommerce-quick-buy-' . get_locale() . '.mo');
            }

            function uwc_button_quick_buy($atts)
            {
            ...
            function uwc_form_quickbuy_func(){
                            ...
                            <div class="uwc-popup-content-left <?php echo ($quickbuy_settings['popup_infor_enable'] == 1) ? '' : 'popup_quickbuy_hidden_mobile';?>">
                                <div class="uwc-popup-prod">
                                    ...
                                    <div class="uwc-popup-info">
                                        <span class="uwc_title"><?php echo $thisProduct->get_title();?></span>
                                        <?php if($thisProduct->get_type() == 'simple'):?><span class="uwc_price"><?php echo $thisProduct->get_price_html(); ?></span><?php endif;?>
                                    </div>
                                </div>
                            ...
                            <div class="uwc-popup-content-right">
                                <form class="uwc_custom_info" id="uwc_custom_info" method="post">
                                    <div class="popup-customer-info">
                                        ...
                                        <?php do_action('before_field_uwc_quickbuy');?>
                                        <div class="popup-customer-info-group popup-customer-info-radio">
                                            <label>
                                                <input type="radio" name="customer-gender" value="1" checked/>
                                                <span><?php _e('Mr','ultimate-woocommerce-quick-buy');?></span>
                                            </label>
                                            <label>
                                                <input type="radio" name="customer-gender" value="2"/>
                                                <span><?php _e('Mrs','ultimate-woocommerce-quick-buy');?></span>
                                            </label>
                                        </div>
                                        ...
                                        <div class="popup-customer-info-group">
                                            <div class="popup-customer-info-item-1">
                                                <?php if($require_email):?>
                                                    <input type="text" class="customer-email" name="customer-email" data-required="true" required placeholder="<?php _e('Email','ultimate-woocommerce-quick-buy');?>">
                                                <?php else:?>
                                                    <input type="text" class="customer-email" name="customer-email" data-required="false" placeholder="<?php _e('Email (Not required)','ultimate-woocommerce-quick-buy');?>">
                                                <?php endif;?>
                                            </div>
                                        </div>
                                        <?php endif;?>
                                        ...
                                        $uwc_available_gateways = array();
                                        if($available_gateways && !empty($available_gateways)){
                                            foreach($available_gateways as $k=>$gateways){
                                                //if($k == 'cod' || $k == 'bacs' ) {
                                                $uwc_available_gateways[$k] = $gateways;
                                                //}
                                            }
                                        }
                                        if( !empty($uwc_available_gateways) ):?>
                                        ...
                                        <div class="popup-customer-info-group popup-customer-info-radio paymentmethob-wrap">
                                            <?php $stt = 1; foreach($uwc_available_gateways as $gateway):?>
                                                <label>
                                        ...
                                        <?php do_action('after_field_uwc_quickbuy');?>
                                    </div>
            ...
            function quick_buy_popup_content($args = array(), $view = true, $f_ajax = false)
            {
                ...
                if($args){
                    ...
                    if($prodID){
                        ...
                        if($thisProduct){
                            ?>
                            <div class="uwc-popup-quickbuy <?php if(!$f_ajax):?>mfp-hide<?php endif;?>" id="popup_content_<?php echo $thisProduct->get_id();?>">
            ...
            function check_plugin_active($base_plugin = 'Uwc-woo-address-selectbox/Uwc-woo-address-selectbox.php'){
                if (
            ...
            function add_button_quick_buy(){
                global $product;
                echo do_shortcode('[uwc_quickbuy view="0" id="'.$product->get_id().'"]');
            }

            function add_quick_buy_to_loop_func(){
                global $product;
                echo do_shortcode('[uwc_quickbuy small_link="1" id="'.$product->get_id().'"]');
            }

            function uwc_get_rates($package = array(), $product_info = array()){
            ...
            function uwc_calculate_shipping($package = array(), $product_info = array()){
            ...
            function load_diagioihanhchinh_func() {
                ...
                if(
                    ...
                    !class_exists('uwc_Woo_Vietnam_Checkout_Class') &&
                    !class_exists('uwc_Woo_GHTK_Class')
                ) wp_send_json_error();
                if(class_exists('Woo_Address_Selectbox_Class')){
                    $address = new Woo_Address_Selectbox_Class;
                }elseif(class_exists('uwc_Woo_Vietnam_Checkout_Class')){
                    $address = new uwc_Woo_Vietnam_Checkout_Class;
                }else{
                    $address = new uwc_Woo_GHTK_Class;
                }
            ...
            public function add_action_links($links, $file)
            {
                if (strpos($file, 'ultimate-woocommerce-quick-buy.php') !== false) {
                    $settings_link = '<a href="' . admin_url('options-general.php?page=ultimate-quickbuy-setting') . '" title="' . __('Settings', 'ultimate-woocommerce-quick-buy') . '">' . __('Settings', 'ultimate-woocommerce-quick-buy') . '</a>';
            ...
            function load_plugins_scripts()
            {
                ...
                $array = array(
                    ...
                    'address_text'  =>  __('Stress is required', 'ultimate-woocommerce-quick-buy')
                );
            ...
            function admin_notices(){
                ...
                if(!$license_key) {
                    printf('<div class="%1$s"><p><strong>Plugin Mua Hàng Nhanh:</strong> Hãy điền <strong>License Key</strong> để tự động cập nhật khi có phiên bản mới. <a href="%2$s">Thêm tại đây</a></p></div>', esc_attr($class), esc_url(admin_url('options-general.php?page=ultimate-quickbuy-setting')));
                }
            }

            function uwc_modify_plugin_update_message( $plugin_data, $response ) {
                global $quickbuy_settings;
                ...
                echo '<br />' . sprintf( __('<strong>Mua bản quyền để được tự động update. <a href="%s" target="_blank">Xem thêm thông tin mua bản quyền</a></strong> hoặc liên hệ mua trực tiếp qua <a href="%s" target="_blank">facebook</a>', 'ultimate-woocommerce-quick-buy'), $PluginURI, 'http://m.me/levantoan.wp');
            }

            function uwc_settings_page()
            {
                global $quickbuy_settings;
                ?>
                <div class="wrap uwc_quickbuy">
                    ...
                    <form method="post" action="options.php" novalidate="novalidate">
                        ...
                        <table class="form-table">
                            <tbody>
                            <tr>
                                <th scope="row"><label for="enable"><?php _e('Enable','ultimate-woocommerce-quick-buy');?></label></th>
                                <td>
                                    <label>
                                        <input type="radio" id="enable" value="1" <?php checked(1,$quickbuy_settings['enable']);?> name="<?php echo $this->_optionName . '[enable]'?>"> <?php _e('Active','ultimate-woocommerce-quick-buy');?>
                                    </label>
                                    <label>
                                        <input type="radio" id="enable" value="0" <?php checked(0,$quickbuy_settings['enable']);?> name="<?php echo $this->_optionName . '[enable]'?>"> <?php _e('Deactive','ultimate-woocommerce-quick-buy');?>
                                    </label>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row"><label for="enable_location"><?php _e('Select location','ultimate-woocommerce-quick-buy');?></label></th>
                                <td>
                                    <label>
                                        <input type="checkbox" id="enable_location" value="1" <?php checked(1,$quickbuy_settings['enable_location']);?> name="<?php echo $this->_optionName . '[enable_location]'?>"> <?php _e('Active','ultimate-woocommerce-quick-buy');?><br>
                                        <small><?php _e('Requires have state','ultimate-woocommerce-quick-buy');?></small>
                                    </label>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row"><label for="enable_ship"><?php _e('Shipping','ultimate-woocommerce-quick-buy');?></label></th>
                                <td>
                                    <label><input type="checkbox" id="enable_ship" value="1" <?php checked(1,$quickbuy_settings['enable_ship']);?> name="<?php echo $this->_optionName . '[enable_ship]'?>"> <?php _e('Active','ultimate-woocommerce-quick-buy');?></label>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row"><label for="enable_coupon"><?php _e('Coupons','ultimate-woocommerce-quick-buy');?></label></th>
                                <td>
                                    <label><input type="checkbox" id="enable_coupon" value="1" <?php checked(1,$quickbuy_settings['enable_coupon']);?> name="<?php echo $this->_optionName . '[enable_coupon]'?>"> <?php _e('Active','ultimate-woocommerce-quick-buy');?></label>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row"><label for="hidden_email"><?php _e('Hidden Email','ultimate-woocommerce-quick-buy');?></label></th>
                                <td>
                                    <label><input type="checkbox" id="hidden_email" value="1" <?php checked(1,$quickbuy_settings['hidden_email']);?> name="<?php echo $this->_optionName . '[hidden_email]'?>"> <?php _e('Active','ultimate-woocommerce-quick-buy');?></label>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row"><label for="require_email"><?php _e('Require Email','ultimate-woocommerce-quick-buy');?></label></th>
                                <td>
                                    <label><input type="checkbox" id="require_email" value="1" <?php checked(1,$quickbuy_settings['require_email']);?> name="<?php echo $this->_optionName . '[require_email]'?>"> <?php _e('Active','ultimate-woocommerce-quick-buy');?></label>
                                </td>
                            </tr>
                            <?php if($this->check_plugin_active()):?>
                                <tr>
                                    <th scope="row"><label for="require_district"><?php _e('Require District','ultimate-woocommerce-quick-buy');?></label></th>
                                    <td>
                                        <label><input type="checkbox" id="require_district" value="1" <?php checked(1,$quickbuy_settings['require_district']);?> name="<?php echo $this->_optionName . '[require_district]'?>"> <?php _e('Require','ultimate-woocommerce-quick-buy');?></label>
                                    </td>
                                </tr>
                                <tr>
                                    <th scope="row"><label for="require_village"><?php _e('Require Village','ultimate-woocommerce-quick-buy');?></label></th>
                                    <td>
                                        <label><input type="checkbox" id="require_village" value="1" <?php checked(1,$quickbuy_settings['require_village']);?> name="<?php echo $this->_optionName . '[require_village]'?>"> <?php _e('Require','ultimate-woocommerce-quick-buy');?></label>
                                    </td>
                                </tr>
                            <?php endif;?>
                            <tr>
                                <th scope="row"><label for="require_address"><?php _e('Require Address box','ultimate-woocommerce-quick-buy');?></label></th>
                                <td>
                                    <label><input type="checkbox" id="require_address" value="1" <?php checked(1,$quickbuy_settings['require_address']);?> name="<?php echo $this->_optionName . '[require_address]'?>"> <?php _e('Require','ultimate-woocommerce-quick-buy');?></label>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row"><label for="enable_payment"><?php _e('Enable Payment methob','ultimate-woocommerce-quick-buy');?></label></th>
                                <td>
                                    <label><input type="checkbox" id="enable_payment" value="1" <?php checked(1,$quickbuy_settings['enable_payment']);?> name="<?php echo $this->_optionName . '[enable_payment]'?>"> <?php _e('Yes/No','ultimate-woocommerce-quick-buy');?></label>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row"><label for="hidden_note"><?php _e('Hidden Note','ultimate-woocommerce-quick-buy');?></label></th>
                                <td>
                                    <label><input type="checkbox" id="hidden_note" value="1" <?php checked(1,$quickbuy_settings['hidden_note']);?> name="<?php echo $this->_optionName . '[hidden_note]'?>"> <?php _e('Active','ultimate-woocommerce-quick-buy');?></label>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row"><label for="hidden_address"><?php _e('Hidden Address','ultimate-woocommerce-quick-buy');?></label></th>
                                <td>
                                    <label><input type="checkbox" id="hidden_address" value="1" <?php checked(1,$quickbuy_settings['hidden_address']);?> name="<?php echo $this->_optionName . '[hidden_address]'?>"> <?php _e('Active','ultimate-woocommerce-quick-buy');?></label>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row"><label for="valid_phone"><?php _e('Valid Phone','ultimate-woocommerce-quick-buy');?></label></th>
                                <td>
                                    <label><input type="checkbox" id="valid_phone" value="1" <?php checked(1,$quickbuy_settings['valid_phone']);?> name="<?php echo $this->_optionName . '[valid_phone]'?>"> <?php _e('Active','ultimate-woocommerce-quick-buy');?></label>
                                </td>
                            </tr>
                            </tbody>
                        </table>
                        ...
                        <table class="form-table">
                            <tbody>
                            <tr>
                                <th scope="row"><label for="in_loop_prod"><?php _e('Hiển thị trong list sản phẩm','ultimate-woocommerce-quick-buy');?></label></th>
                                <td>
                                    <label><input type="checkbox" id="in_loop_prod" value="1" <?php checked(1,$quickbuy_settings['in_loop_prod']);?> name="<?php echo $this->_optionName . '[in_loop_prod]'?>"> <?php _e('Active','ultimate-woocommerce-quick-buy');?></label>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row"><label for="button_text1"><?php _e('Button text','ultimate-woocommerce-quick-buy');?></label></th>
                                <td>
                            ...
                            <tr>
                                <th scope="row"><label for="button_text2"><?php _e('Button sub text','ultimate-woocommerce-quick-buy');?></label></th>
                                <td>
                        ...
                        <table class="form-table">
                            <tbody>
                            <tr>
                                <th scope="row"><label for="popup_infor_enable"><?php _e('View product info on mobile','ultimate-woocommerce-quick-buy');?></label></th>
                                <td>
                                    <label><input type="radio" id="popup_infor_enable" value="1" <?php checked(1,$quickbuy_settings['popup_infor_enable']);?> name="<?php echo $this->_optionName . '[popup_infor_enable]'?>"> <?php _e('Yes','ultimate-woocommerce-quick-buy');?></label>
                                    <label><input type="radio" id="popup_infor_enable" value="2" <?php checked(2,$quickbuy_settings['popup_infor_enable']);?> name="<?php echo $this->_optionName . '[popup_infor_enable]'?>"> <?php _e('No','ultimate-woocommerce-quick-buy');?></label>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row"><label for="popup_title"><?php _e('Popup title','ultimate-woocommerce-quick-buy');?></label></th>
                                <td>
                                    ...
                                    <br><small><?php _e('%s to view product title','ultimate-woocommerce-quick-buy');?></small>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row"><label for="popup_mess"><?php _e('Popup mess','ultimate-woocommerce-quick-buy');?></label></th>
                                <td>
                                    <?php
                                    $settings = array(
                            ...
                            <tr>
                                <th scope="row"><label for="popup_gotothankyou"><?php _e('Go to thank you page','ultimate-woocommerce-quick-buy');?></label></th>
                                <td>
                                    <label><input type="checkbox" id="popup_gotothankyou" value="1" <?php checked(1,$quickbuy_settings['popup_gotothankyou']);?> name="<?php echo $this->_optionName . '[popup_gotothankyou]'?>"> <?php _e('Active','ultimate-woocommerce-quick-buy');?></label>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row"><label for="popup_sucess"><?php _e('Checkout successfully mess','ultimate-woocommerce-quick-buy');?></label><br>
                                    <small><?php _e('Type %%order_id%% to view Order ID','ultimate-woocommerce-quick-buy')?></small></th>
                                <td>
                                    <?php
                                    $settings = array(
                            ...
                            <tr>
                                <th scope="row"><label for="popup_error"><?php _e('Checkout error message','ultimate-woocommerce-quick-buy');?></label></th>
                                <td>
                            ...
                            <tr>
                                <th scope="row"><label for="out_of_stock_mess"><?php _e('Out of stock message','ultimate-woocommerce-quick-buy');?></label></th>
                                <td>
                        ...
                        <!--<h2><?php _e('License','ultimate-woocommerce-quick-buy');?></h2>
                        <table class="form-table">
                            <tbody>
                                <tr>
                                    <th scope="row"><label for="license_key"><?php _e('License key','ultimate-woocommerce-quick-buy');?></label></th>
                                    <td>
                                        ...
                                        <?php if(!$quickbuy_settings['license_key']):?><br><small><?php echo sprintf( __('<strong>Gửi email + domain qua <a href="%s" target="_blank">facebook</a> để nhận license<strong>', 'ultimate-woocommerce-quick-buy'), 'http://m.me/levantoan.wp');?></small><?php endif;?>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
						-->
                        <?php do_settings_fields('ultimate-quickbuy-options-group', 'default'); ?>
            ...
            function uwc_form_quick_buy($atts){
                $atts = shortcode_atts( array(
                    'id' => ''
                ), $atts, 'uwc_quickbuy_form' );
                ...
                if($thisProduct && !is_wp_error($thisProduct)){
                    ob_start();
                    ?>
                    <div class="uwc-popup-quickbuy Uwc-form-quickbuy-inline">
                        <div class="uwc-popup-inner">
            ...
            function uwc_apply_coupon_func(){
                global $quickbuy_settings;
            ...
            function uwc_apply_coupons($thisCoupon = '', $package = array(), $product_info = array()){
            ...
            function uwc_woocommerce_quantity_input_args($args){
