...
if(!class_exists('quickbuy_auto_update')) {
    ...
    add_action('init', 'uwc_quickbuy_auto_update' );
    function uwc_quickbuy_auto_update()
    {
        ...
        $uwc_plugin_current_version = uwc_QB_VERSION_NUM;
        $uwc_plugin_remote_path = 'http://license.levantoan.com/wp-admin/admin-ajax.php?action=uwc_update&slug=Uwc-quick-buy&getremote=update&license='.$license_key;
        $uwc_plugin_slug = uwc_QB_BASENAME;
        new quickbuy_auto_update ($uwc_plugin_current_version, $uwc_plugin_remote_path, $uwc_plugin_slug);
    }
}
